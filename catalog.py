    ...
    "project_cost": [
        {
            ...
            "title": "{name} per m2 Guide",
            "description": "See how area, finish level, labour, and contingency affect the real cost per square metre for {name}.",
