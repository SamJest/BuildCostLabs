...
def build_paint_calculator_page() -> str:
    ...
    form_html = """<div class="toggle-row" role="tablist" aria-label="Paint mode"><button class="mode-toggle is-active" data-mode="walls" type="button">Walls</button><button class="mode-toggle" data-mode="ceiling" type="button">Ceiling</button><button class="mode-toggle" data-mode="single" type="button">Single surface</button></div><div class="toggle-row units-row" role="tablist" aria-label="Units"><button class="unit-toggle is-active" data-unit="metric" type="button">Metric</button><button class="unit-toggle" data-unit="imperial" type="button">Imperial</button></div><form id="paint-form" class="calculator-form"><div class="field-grid"><label><span>Length</span><input id="length" type="number" min="0" step="0.01" value="4"></label><label><span>Width</span><input id="width" type="number" min="0" step="0.01" value="3"></label><label><span>Height</span><input id="height" type="number" min="0" step="0.01" value="2.4"></label><label><span>Coats</span><input id="coats" type="number" min="1" step="1" value="2"></label><label><span>Coverage per litre (m2)</span><input id="coverage" type="number" min="0" step="0.1" value="12"></label><label><span>Waste allowance (%)</span><input id="waste" type="number" min="0" step="1" value="10"></label><label><span>Price per litre</span><input id="price-per-litre" type="number" min="0" step="0.01" value="8.50"></label></div><button class="btn btn-primary btn-block" type="submit">Calculate paint</button></form>"""
