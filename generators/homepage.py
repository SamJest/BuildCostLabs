  ...
  <div class="site-shell">
    ...
    <section class="conversion-panel">
      <div class="section-head">
        ...
        <p>Use the calculator result as your starting number, then turn it into a cleaner builder or supplier request with the quote-prep checklist and the contact guidance page.</p>
      </div>
      <div class="conversion-actions">
        <a class="btn btn-primary" href="/quote-checklist/" data-conversion-link="quote-checklist">Open quote checklist</a>
        <a class="btn" href="/contact/" data-conversion-link="contact">Contact BuildCostLab</a>
      </div>
    </section>
  </div>'''
